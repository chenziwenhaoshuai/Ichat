...
class xiaoiceApi():
    ...
    def chat(self, input_strs):
        ...
        data = {
            'text': input_strs,
            'uid':5175429989,
            'extensions':'{"clientid": "d18nk1evldomt8o5l7mgz4p62ovyr"}',
            'is_encoded':0,
            'decodetime':'1',
            'source':209678993
        }
        ...
        try:
            ...
            #niubi = page.json()['status_id']
            #print(niubi)
            if str(page.json()['status_id']) == '0':
    ...
    def loop(self, input_strs):
        ...
        while times <= 20:
            ...
            """https://rm.api.weibo.com/2/remind/push_count.json?source=209678993&with_dm_group=true&with_chat_group=true&with_dm_unread=1&with_settings=1&sign_val=newChat&callback=__jp15"""
